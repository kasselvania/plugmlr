...
b:request('tempo',{'tempo-reply'});assert(sent[#sent][3][1]==0)
b:request('tempo-set',{'tempo-reply',90,'manual'});assert(b.tempo_bpm==90)
...
b:in_1_symbol('/test/replacement.wav');b:metadata('list',source);assert(not b.tempo_bpm)
