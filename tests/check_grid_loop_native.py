...
check('connected 1',['led /monome/grid/led/row 0 0 0 0','led /monome/grid/led/level/set 1 0 8','led /monome/grid/led/level/set 15 0 4','led /monome/grid/led/level/set 13 0 4'])
check('key 1 2 0',[])
# MOD loops on down, never on either release; ALT retains priority.
check('key 13 0 1',['led /monome/grid/led/level/set 13 0 15'])
check('key 4 1 1',['focus 1','loop 1 4 5'])
check('key 4 1 1',[])
check('key 4 1 0',[])
check('key 13 0 0',['led /monome/grid/led/level/set 13 0 4'])
check('key 13 0 1',['led /monome/grid/led/level/set 13 0 15'])
check('key 15 1 1',['loop 1 15 16'])
check('key 13 0 0',['led /monome/grid/led/level/set 13 0 4'])
check('key 15 1 0',[])
check('key 2 1 1',['slice 2 1 1'])
check('key 6 1 1',[])
...
check('key 6 1 0',[])
check('key 2 1 0',[])
check('key 0 2 1',['focus 2','loop 2 0 1'])
check('key 0 2 0',[])
check('key 15 0 1',['led /monome/grid/led/level/set 15 0 15'])
check('key 3 2 1',['play 2'])
check('key 3 2 0',[])
check('key 15 0 0',['led /monome/grid/led/level/set 15 0 4'])
check('key 7 2 1',['loop 2 7 8'])
check('connected 0',[])
check('connected 1',['led /monome/grid/led/row 0 0 0 0','led /monome/grid/led/level/set 1 0 8','led /monome/grid/led/level/set 15 0 4','led /monome/grid/led/level/set 13 0 4'])
check('key 7 2 0',[])
check('key 7 2 1',['slice 7 2 1'])
