...
for p in ['mlr.pd','sample_player_rebuild.pd','loop-region-control.pd','loop-region-live.pd','grid-loop-region.pd','grid-cut-control.pd','mlr-grid-compat.pd_lua']:
...
# Later MOD input changes are guarded by check_grid_mod.py and native gestures.
